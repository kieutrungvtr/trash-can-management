...
class AddData extends Migration
{
    ...
    public function up()
    {
        ...
        DB::insert("insert into trash_type (trash_type_id, trash_type_color, trash_type_name, trash_type_description) value (6, 'indigo', 'Rác thải bông, vải sợi', 'tã giấy, băng vệ sinh, quần áo, vải vụn thải bỏ, tất chân, găng tay… và giấy ăn, giấy vệ sinh, giấy lau, đầu mẩu thuốc lá, giấy bọc kẹo bánh…');", []);
